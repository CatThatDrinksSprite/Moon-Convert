...
if game.Players.LocalPlayer.Character:FindFirstChild("AuroraSword") then
  ...
  AlignCharacter(game.Players.LocalPlayer.Character["AuroraSword"].Handle, game.Players.LocalPlayer.Character.sword1.Handle, Vector3.new(0, 3, -0.2), Vector3.new(-40, 120, 180))
  AlignCharacter(game.Players.LocalPlayer.Character["RainbowGodSword"].Handle, game.Players.LocalPlayer.Character.sword2.Handle, Vector3.new(0, 3, -0.2), Vector3.new(-40, 120, 180))
  for index, asset in pairs(game.Players.LocalPlayer.Character.sword1:GetChildren()) do
    if asset:IsA("BasePart") then
        asset.Transparency = 1
    end
  end
  for index, asset in pairs(game.Players.LocalPlayer.Character.sword2:GetChildren()) do
    if asset:IsA("BasePart") then
        asset.Transparency = 1
    end
  end
else
	sendNotification("Moon Convert", "It is recommended to wear the hats used for this script... You can get the hats by using \"get hats;dual ultima\"", 7)
end
