...
if game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory") then
  ...
  AlignCharacter(game.Players.LocalPlayer.Character["MeshPartAccessory"].Handle, game.Players.LocalPlayer.Character.Model.TrueHandle, Vector3.new(-3, 0, 0), Vector3.new(0, 0, -45))
