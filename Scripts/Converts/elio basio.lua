...
loadstring(game:HttpGet("https://github.com/CatThatDrinksSprite/Moon-Convert/blob/main/Scripts/Other/AlignCharacter.lua", true))()
...
if game.Players.LocalPlayer.Character:FindFirstChild("Accessory (modelAccessory)") then
	...
	sendNotification("Moon Convert", "It is recommended to wear the hats used for this script... You can get the hats by using \"get hats;elio basio\"", 7)
end
