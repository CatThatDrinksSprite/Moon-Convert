...
if game.Players.LocalPlayer.Character:FindFirstChild("Shopping Cart") then
    game.Players.LocalPlayer.Character["Shopping Cart"].Handle.AccessoryWeld:Destroy()
    AlignCharacter(game.Players.LocalPlayer.Character["Shopping Cart"].Handle, game.Players.LocalPlayer.Character.Torso.Part, Vector3.new(0, 0.1, 1), Vector3.new(0,0,0))
    for index, asset in pairs(game.Players.LocalPlayer.Character.Torso:GetChildren()) do
