...
local b, script = xpcall(function()
	return game:GetObjects("rbxassetid://114645651684830")[1]
end, function()
	return script
end)
...
if game.Players.LocalPlayer.Character:FindFirstChild("Accessory (StrikerAccessory)") then
	game.Players.LocalPlayer.Character["Accessory (StrikerAccessory)"].Handle.AccessoryWeld:Destroy()
	AlignCharacter(game.Players.LocalPlayer.Character["Accessory (StrikerAccessory)"].Handle, game.Players.LocalPlayer.Character.Bazooka, Vector3.new(0, 0, 0), Vector3.new(0, -90, 0))
	game.Players.LocalPlayer.Character.Bazooka.Transparency = 1
else
	sendNotification("Moon Convert", "It is recommended to wear the hats used for this script... You can get the hats by using \"get hats;banzai bazooka\"", 7)
end
