...
scriptcmds = {
  ...
  ["doll;46"] = function()
    sendNotification("Moon Convert", "Ran!", 7)
    if game.Players.LocalPlayer.Character:FindFirstChild("Model") then
      loadstring(game:HttpGet("https://github.com/luanecoarc/Moon-Convert/raw/main/Scripts/Converts/doll%3B46.lua", true))()
    else
      sendNotification("Moon Convert", "Please use command \"reanimate\" first.", 7)
    end
  end,
  ["get hats;doll"] = function()
    ...
    if game.Players.LocalPlayer.Character:FindFirstChild("Model") then
      ...
      game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("-gh 451220849 29532720 62724852 63690008 62234425")
    end
  end
}
